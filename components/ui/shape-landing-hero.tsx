            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    >
                        ...
                        <p className="text-base sm:text-xl md:text-xl text-white/90 mb-4 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
                            Developing exceptional digital experiences through
                            innovative Idea and cutting-edge technology.
                        </p>
