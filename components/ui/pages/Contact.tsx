...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen pt-30 ml-64 bg-black text-white py-16 px-4 sm:px-6">
      <motion.div
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          ...
          <motion.div
            variants={itemVariants}
            className="bg-gradient-to-b from-purple-900/50 to rounded-xl p-6 shadow-lg"
          >
