...
export default function Projects() {
  return (
    <div className="flex flex-col gap-8 pt-30 pb-20 py-8 ml-64 bg-black text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-gray-950 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
          ...
          <div className="p-6 bg-slate-950/50 backdrop-blur-sm">
            ...
            <p className="text-gray-300 mb-4">
              A full-stack NextJS App which shows the platform of RBased
              organisation built with React, NextJS, and PostgreSQL and Prisma
              ORM.
            </p>
            ...
            <div className="flex space-x-4">
              <a
                href="https://rbased-pvt-ltd-five.vercel.app/"
                target="_blank"
              ...
              <a
                href="https://github.com/gulshank0/rbased-pvt-ltd"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="bg-gray-950 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
          ...
          <div className="p-6">
            ...
            <p className="text-gray-300 mb-4">
              An AI-powered Web-App generation tool that creates basic
              Boilerplate code of Starting the project. Built with React, NodeJS
              as backend, and integrated with Gemini API.
            </p>
            <div className="flex flex-wrap gap-2 mb-4">
              <span className="bg-slate-700 px-3 py-1 rounded-full text-sm">
                React
            ...
            <div className="flex space-x-4">
              <a
                href="https://github.com/gulshank0/bolt-clone"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-slate-700 hover:bg-slate-600 text-white px-4 py-2 rounded-md transition-colors"
              >
